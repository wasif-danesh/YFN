...
This diagram reflects the delivered [SQLite database](sample.sqlite), not an unimplemented target. It shows selected columns; the [column dictionary](data-dictionary.md) and [SQL DDL](../../../pipeline/greater_melbourne_schema.sql) contain the full schema. The editable source is [schema-erd.mmd](schema-erd.mmd).
